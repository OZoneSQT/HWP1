...
typedef void (*Timer8BitInterruptCallback)(void);
typedef void (*TimerInterruptCallback)(void);


// Custom type for timer
typedef uint32_t MS_t;
typedef uint8_t SS_t;
typedef uint8_t MM_t;
typedef uint8_t HH_t;
...
/*																		*/
/* @param[in] uint16_t time in ms										*/
/* @param[in] *Timer8BitInterruptCallback pointer, can be NULL 			*/
/************************************************************************/
...
/* @param[in] uint8_t add minutes to time 								*/
/* @param[in] uint8_t add hours to time 								*/
/* @param[in] *Timer16BitInterruptCallback pointer, can be NULL 		*/
/************************************************************************/
...
/* @param[in] *Timer16BitInterruptCallback pointer, can be NULL 		*/
/************************************************************************/
void init32BitTimerCallback(Timer16Bit timer1, Timer16Bit timer2, TimerInterruptCallback callcack, ...);
