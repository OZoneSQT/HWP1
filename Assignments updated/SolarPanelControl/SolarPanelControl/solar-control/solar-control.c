...
void solar_control_init()
{
	/*
		...
		J15 pin		Function	Port pin	Def		Enum
		1			TO			PD7			D38		D_PIN31
		3			OC0B		PG5			D4		D_PIN53
		5			OC1B		PB6			D12		D_PIN14
		7			OC2B		PH6			D9		D_PIN60
		9			OC3B		PE4			D2		D_PIN36
		11			ICP4		PL0			D49		D_PIN70
		13			OC4B		PH4			D7		D_PIN58
		15			T5			PL2			D47		D_PIN72
		
		J15 pin		Function	Port pin	Def		Enum
		2			OC0A		PB7			D13		D_PIN15
		4			OC1A		PB5			D11		D_PIN13
		6			OC2A		PB4			D10		D_PIN12
		8			OC3A		PE3			D5		D_PIN35
		10			OC3C		PE5			D3		D_PIN37
		12			OC4A		PH3			D6		D_PIN57
		14			OC4C		PH5			D8		D_PIN59
		16			ICP5		PL1			D48		D_PIN71
*/
	
	thermometer_init();
	//matrix_init(D38, D4, D12, D9, D2, D49, D7, D47);	// 1-15
	matrix_init(D13, D11, D10, D5, D3, D6, D8, D48);	// 2-16
